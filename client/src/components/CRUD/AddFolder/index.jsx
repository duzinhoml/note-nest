...
function AddFolder() {
    ...
    const handleFormSubmit = async (e) => {
        ...
        try {
            ...
            document.getElementById('closeAddFolderModalBtn').click();
        } 
        catch (err) {
            console.error(err)
        }
    ...
    return (
        <>
            ...
            {/* <!-- Modal --> */}
            <div class="modal fade" id="addFolderModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h1 class="modal-title fs-5" id="staticBackdropLabel">Create a New Folder</h1>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" id="closeAddFolderModalBtn" aria-label="Close"></button>
                        </div>
